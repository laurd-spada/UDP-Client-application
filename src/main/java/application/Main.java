    ...
    public static void main(String[] args) {
        try{
            ...
            do {
                ...
                datagramSocket.receive(datagramPacket); // We are receiving the data from host here
                System.out.println("Text received is: " + new String(buffer1,0,datagramPacket.getLength()));
